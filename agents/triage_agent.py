...
class ModularTriageAgent(BaseAgent):
    ...
    def __init__(self, model_manager, interactive: bool = False, checkpoint_callback = None):
        super().__init__("triage", model_manager, interactive=interactive, checkpoint_callback=checkpoint_callback)
...
SECURITY requests include:
- "Audit user permissions on the server"
...
- ANY request mentioning: audit, permissions, login, firewall, malware, intrusion, access control

DEVELOPMENT/CODING requests include:
- "Write a Python/JavaScript/bash script"
- "Create a hello world program"
- "Generate code for X"
- "Write a function that does Y"
...
- ANY request asking to write/create/generate code, scripts, or programs
- Keywords: "write", "code", "script", "program", "function", "class", "module"
